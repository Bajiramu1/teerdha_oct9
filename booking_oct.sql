...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 08, 2024 at 05:42 AM
...
(649, 'Can add sidebar_dashboard', 132, 'add_sidebar_dashboard'),
(650, 'Can change sidebar_dashboard', 132, 'change_sidebar_dashboard'),
(651, 'Can delete sidebar_dashboard', 132, 'delete_sidebar_dashboard'),
(652, 'Can view sidebar_dashboard', 132, 'view_sidebar_dashboard'),
(653, 'Can add profile', 133, 'add_profile'),
(654, 'Can change profile', 133, 'change_profile'),
(655, 'Can delete profile', 133, 'delete_profile'),
(656, 'Can view profile', 133, 'view_profile'),
(657, 'Can add profiles', 134, 'add_profiles'),
(658, 'Can change profiles', 134, 'change_profiles'),
(659, 'Can delete profiles', 134, 'delete_profiles'),
(660, 'Can view profiles', 134, 'view_profiles');
...
(5, 'pbkdf2_sha256$720000$3WBRVhxCA10C0nnsQ6FMDb$xKXlmoNzsEe56Jcz0n07ku/vXHp+inSP4CI3KErK2qU=', '2024-07-23 11:38:50.238234', 1, 'Rrr', '', '', 'reecha.arava@developtrees.com', 1, 1, '2024-06-26 03:53:19.000000'),
(8, 'pbkdf2_sha256$600000$xOZjVL8j2K4m9QTWnXEv4b$gsW/j0teMylHTZE7FWIqS7uF6zAcANxI6aaWsFNANvw=', '2024-10-04 04:41:25.198085', 1, 'Developtrees', '', '', 'reecha.arava@developtrees.com', 1, 1, '2024-07-23 11:45:45.000000'),
(9, 'pbkdf2_sha256$600000$rML2ievDbyH0Yt8ShINzqW$aJIrmmFZEhGBXZCZltKQnHKQw6lxSkS1RYGDL67qUZs=', '2024-07-25 04:02:04.938837', 1, 'nani', '', '', '', 1, 1, '2024-07-24 06:02:49.158899');
...
(20, 'Travel Party.', '/bus_home21/', '/bus_update21/1/'),
(21, 'Ganesha Offer !', '/bus_home20/', '/bus_update20/1/'),
(22, 'Bank Offer !', '/bus_home22/', '/bus_update22/1/'),
...
(1, 'Ayodhya Travel Guide.', '/bus_update/1/'),
(2, 'Steal the Deal.', '/bus_update/2/'),
(3, 'Plan your Trip With Us!', '/bus_update/3/'),
(4, 'Travellings in India?', '/bus_update/4/'),
(5, 'New User Offer!', '/bus_update/5/'),
(6, 'Mega Deals on Booking!', '/bus_update/6/'),
(7, 'Deal of the Day.', '/bus_update/7/'),
(8, 'Special Offer of the Week.', '/bus_update/8/'),
(9, 'Travel Party.', '/bus_update/9/'),
(10, 'Ganesha Offer !', '/bus_update/10/'),
(11, 'Bank Offer !', '/bus_update/11/'),
(12, 'Holiday Packages !', '/bus_update/12/'),
(13, 'Ride More Save More!', '/bus_update/13/');
...
(1, '', 'What do you get?', 'Applicable to all users: flat Rs. 100 discount.'),
(2, '', 'How do you get it?', 'Get 10% off your bus ticket booking! Available to all credit and debit cardholders.'),
(3, '', '', 'To book your ticket, use the code: BUSDAY.'),
(4, '', '', 'The discount coupon code is valid for bus bookings.'),
(5, '', '', 'Get 10% off your bus ticket booking.'),
(6, '', '', 'The discounted amount will be subtracted from the total amount payable.'),
(7, '', '', 'The offer is valid for bookings made on Teerdha\'s website, mobile site, and Android and iOS apps.'),
(8, '', 'What else do you need to know?', 'The offers will be calculated on the base fare.'),
(9, '', '', 'Paytm announces free bus ticket cancellations after the lockdown.'),
(10, '', '', 'In the case of partial or full cancellation, the offer becomes void and the discount will be rolled back before processing the refund.'),
(11, '', '', 'Name changes are not allowed.'),
(19, '', 'Conditions Incase of Cancellations:', 'If tickets are canceled more than 12 hours before the bus departure, a refund will be allowed after deducting 10% of the ticket amount.'),
(20, '', '', 'If tickets are canceled within 12 hours of the bus departure, a refund will be allowed after deducting 25% of the ticket amount.'),
(21, '', '', 'If tickets are canceled within 2 hours after the bus departure, a refund will be allowed after deducting 75% of the ticket amount.'),
(22, '', '', 'If tickets are canceled more than 2 hours after the bus departure, no refund will be allowed.'),
(23, '', '', 'Reservation or handling charges, if any, are non-refundable.'),
(24, '', 'Terms & Conditions:', 'In the event of any misuse or abuse of the offer, Teerdha reserves the right to deny the offer to customers.'),
(25, '', '', 'Teerdha is the sole authority on the interpretation of these terms.'),
(26, '', '', 'In addition, Teerdha’s standard booking, cancellation, and privacy policies will apply.'),
(27, '', '', 'In the event of any dispute, the courts in New Delhi will have jurisdiction.'),
(28, '', '', 'Travel agents are excluded from this offer.'),
(29, '', '', 'Teerdha reserves the right to disqualify any transaction or discontinue the offer at any time without notice or liability of any kind.'),
(30, '', '', 'This offer cannot be combined with any other offers.\r\n\r\n\r\n\r\n\r\n\r\n\r\nThis offer cannot be combined with any other offers.”\r\n\r\n\r\n\r\n\r\n\r\n\r\n'),
(31, '', '', 'Teerdha shall not be liable for any loss or damage resulting from force majeure.');
...
(1, 'images/dealoftheday.jpg', 'What do you get?', 'Users will receive a minimum of 10% off on bus tickets.'),
(2, '', 'How do you get it?', 'To avail of the offers, users must book bus tickets for their preferred destination using the promo code: EASEDAY.'),
(3, '', '', 'This offer is valid only on Sunday and Monday.'),
(4, '', '', 'All our new and existing customers can take advantage of this offer.'),
(5, '', '', 'The promo code is valid for bus bookings.'),
(6, '', '', 'The offer is valid for bookings made on Teerdha\'s website, mobile site, and Android and iOS apps.'),
(7, '', 'What else do you need to know?', 'The offer cannot be combined with any other promotional offers.'),
(8, '', '', 'The offers will be calculated on the base fare.'),
(9, '', '', 'This offer is exclusive to bookings made with a valid promo code.'),
(10, '', '', 'In the event of a partial or full cancellation, the offer becomes invalid, and any discount will be removed before the refund is processed.'),
(11, '', '', 'Name changes are not allowed.'),
(22, '', 'Conditions Incase of Cancellations :', 'The cancellation fee will be deducted from the total collected amount.'),
(23, '', '', 'Cancellation slabs (% fare refund) are based on the time of cancellation relative to the departure time of the service at the place of boarding.'),
(24, '', '', 'For ticket cancellations, a cancellation fee is calculated based on the applicable journey fare.'),
(25, '', '', 'Ticket cancellations with discounts will follow the above procedure. However, cancellation charges will be calculated based on the basic fare payable by the passenger. The refund amount will be the actual fare collected minus the cancellation fee.'),
(26, '', '', 'The reservation fee is non-refundable.'),
(27, '', '', 'Bridge fees, user fees, toll fees, entry fees, etc. will be fully refunded.'),
...
(29, '', '', 'The offer is valid for online and mobile bookings.\r\n\r\n\r\n\r\n\r\n\r\n\r\n'),
(30, '', '', 'The discounted amount will be deducted from the total amount payable.'),
(31, '', '', 'A user can use one promo code twice during the offer period.'),
(32, '', '', 'Enjoy your booking and happy traveling!'),
(33, '', '', 'Additionally, Teerdha’s standard booking and privacy policies, as detailed at www.teerdha.com, will apply.'),
(34, '', '', 'In the event of any dispute, the courts in New Delhi will have jurisdiction.'),
(35, '', '', 'Teerdha reserves the right, without prior notice, liability, or explanation, to adjust, amend, or replace all or part of these terms and conditions. This includes the option to substitute this offer with another offer, whether similar or not, or to extend or withdraw it completely.'),
(36, '', '', 'Teerdha has absolute authority over the interpretation of these terms.'),
(37, '', '', 'Teerdha shall not be liable for any loss or damage resulting from force majeure.');
...
(1, 'How can you book a bus ticket online using Teerdha?', 'Booking a bus ticket online in India is straightforward with TEERDHA. Enter the departure city, destination city, and travel date in the search option on the website. You\'ll quickly receive a list of available buses for your route. Choose the bus that fits your needs, then proceed with the booking by selecting your seat, entering passenger details, and completing the payment. After a successful booking, you’ll receive an e-ticket via SMS/WhatsApp and email.'),
(2, 'Is creating an account necessary to book bus tickets on Teerdha?', 'No, you can book bus tickets as a guest by providing the necessary passenger information. However, creating an account is advisable to receive updates on bus availability, ticket information, and other features that can streamline future bookings.'),
(3, 'What is the process for signing up on Teerdha?', 'You can sign up with your mobile number. Teerdha provides a simple one-step sign-up and login process using an OTP sent to your phone.'),
(4, 'Are discounts and offers available on bus tickets at Teerdha?', 'Yes, you can receive the best fares on bus ticket bookings at Teerdha by applying coupon codes before finalizing your transaction. For the lowest prices, always check the Teerdha Bus Offers page when booking online.'),
(5, 'What documents do I need to bring with me when getting on the bus?', 'You can present any of the following forms of ID while traveling: PAN Card, Aadhar Card, Voter ID Card, Driving License, Student ID Card, or Passport.'),
(6, 'I applied the promo code on Teerdha but didn’t get any cashback. What actions should I take?', 'If you applied a valid cashback coupon code during your booking, the cashback will be credited to TeerdhaCash after your travel date. Be sure to review the terms and conditions of the promotion. If you haven\'t received the cashback according to these terms, please email us at support@teerdha.com with your booking details and the applied promotional offer.'),
(7, 'What is the process for changing the date of my bus ticket?', 'Online bus tickets cannot be rescheduled. Instead, you need to cancel your current ticket using the cancellation process and then book a new ticket for your updated date. For a faster experience, select Teerdhacash as your refund option to avoid having to make a payment on your next booking.'),
(8, 'What steps should I follow if I can\'t find my ticket?', 'If you lose your online bus booking ticket, you can either display the message sent to your mobile number or WhatsApp, or log in to your email to print out the e-ticket. For additional help, please reach out to our customer support team.'),
(9, 'Can I cancel my bus ticket at any time?', 'Yes, you can. After booking your bus ticket online, simply log in to the Teerdha website or app and follow the steps to cancel it.'),
(10, 'What payment methods does Teerdha offer?', 'We offer several payment methods for your booking, including debit and credit cards, net banking, digital wallets, UPI, cash cards, and more.');
...
(1, 'How do you get it?', 'To avail the discount, users have to book bus tickets for their preferred destination by applying the coupon displayed on the page.', ''),
(2, '', 'Users get an instant discount of Rs. 500 on bus ticket bookings.', ''),
(3, '', 'Minimum order value: Rs. 250.', ''),
(4, '', 'All our new and existing customers can avail themselves of this offer.', ''),
(5, '', 'The coupon code is valid only for bus bookings.', ''),
(6, '', 'The offer is valid for bookings made on Teerdha\'s website, mobile site, Android app, and iOS app.', ''),
(7, 'What else do you need to know?', 'The minimum transaction value required to avail the discount is INR 500.', ''),
(8, '', 'This offer is valid for transactions made through mobile wallets, UPI, debit/credit cards, cash, and more.', ''),
(9, '', 'The offer is valid for bus bookings made with Teerdha.', ''),
(10, '', 'The offer can\'t be combined with any other promotional offers.', ''),
(11, '', 'Only bookings with valid promo codes will be eligible for this offer.', ''),
(12, '', 'In the case of partial or full cancellation, the offer becomes void, and the discount will be rolled back before processing the refunds.', ''),
(13, '', 'Name changes are not allowed.', ''),
(28, '', '', 'images/enjoy_tour_travel.png'),
(29, 'Conditions Incase of Cancellations :', 'If the customer cancels the travel service purchase after the discount has been credited, Teerdha will deduct the discount amount from the refund, and cancellation charges will apply.', ''),
(30, '', 'In the case of partial cancellation, the offer becomes void if the revised booking amount is not eligible for the discount or cashback. The discount will then be appropriately adjusted based on the revised booking amount.', ''),
(31, '', 'In the case of full cancellation, the offer becomes void, and the customer will not be eligible for the discount.', ''),
(32, '', 'Upon cancellation, the refund will be credited to the original payment source within three to ten working days.', ''),
(33, '', 'A ticket that has been transferred cannot be transferred or canceled again.', ''),
(34, 'Terms & Conditions:', 'To avail of the discount, the user needs to have a verified mobile number on Teerdha.', ''),
...
(37, '', 'To avail of the cashback, you need to enter the code displayed on the booking screen. The cashback will be in the form of Via points, which will be credited to your Teerdha account.', ''),
...
(42, '', 'Additionally, the standard booking and privacy policies, available at www.teerdha.com, will be enforced by Teerdha.', ''),
...
(1, '', 'images/FESTIVALBUS.png', 'How can you obtain it?', 'Festival Offer: Save Up to Rs. 900.'),
(2, '', '', '', 'Get 30% off your bus ticket booking! Available for all credit and debit cardholders.'),
(4, '', '', '', 'To book the ticket, use this code: FESTIVALBUS.'),
(5, '', '', '', 'The discount coupon code is valid for bus bookings only.'),
...
(9, '', '', '', 'Paytm announces free bus ticket cancellations following the lockdown.'),
(10, '', '', '', 'In case of partial or full cancellation, the offer will be void, and the discount will be rolled back before processing the refunds.'),
(11, '', '', '', 'Changes to names are not allowed.'),
...
(13, '', '', 'Terms & Condition:', 'In the event of any misuse or abuse of the offer, Teerdha reserves the right to deny the offer to customers.'),
(14, '', '', '', 'Teerdha is the sole authority for interpreting these terms.'),
(15, '', '', '', 'In addition, Teerdha\'s standard booking, cancellation, and privacy policies will apply.'),
(16, '', '', '', 'In the event of any dispute, the courts of New Delhi will have jurisdiction.'),
...
(1, 'New User Offer!', 'Valid Until: All Days Except Monday.', 'Coupon Code: FIRSTBUS.', 'images/FIRST_USER.png');
...
(1, 'What do you get?', 'Users will receive a minimum of 20% off on bus tickets.'),
(2, '', 'To avail of the offers, users must book bus tickets for their preferred destination and apply the promo code: FIRSTBUS.'),
(3, '', 'This offer is valid every day except Monday.'),
(4, '', 'The promo code is valid for bus bookings.'),
(5, '', 'The offer is valid for bookings made on Teerdha\'s website, mobile site, and Android and iOS apps.'),
(6, '', 'The offer cannot be combined with any other promotional offers.'),
(7, '', 'The offers will be calculated on the base fare.'),
(8, '', 'This offer is exclusive to bookings made with a valid promo code.'),
(9, '', 'If a partial or full cancellation occurs, the offer becomes invalid, and any discount will be removed before the refund is processed.'),
(10, '', 'Name changes are not permitted.'),
(11, 'Conditions Incase of Cancellations :', 'Partial cancellation is possible.'),
(12, '', 'Partial cancellations will be processed for a refund immediately.'),
(13, '', 'Teerdha reserves the right to change cancellation policies at any time without prior notice.'),
(14, '', 'Upon cancellation, the refund will be credited to the original payment method within three to ten working days.'),
(15, '', 'A ticket once transferred cannot be transferred or canceled again.');
...
(1, 'Terms & Conditions :', 'Use code FIRSTBUS to get a 20% discount, up to Rs. 200, on bus ticket bookings.'),
...
(6, '', 'The offer is applicable only once per customer email or mobile number.'),
(7, '', 'The offer is valid only for logged-in users who verify their mobile number with an OTP (one-time password).'),
(8, '', 'The offer is valid for new users only once per user during the offer period.'),
(9, '', 'This offer cannot be combined with any other offers.'),
(10, '', 'Teerdha reserves the right to disqualify any transaction or discontinue the offer at any time without notice or liability of any kind.'),
(11, '', 'Teerdha is the sole authority on the interpretation of these terms.');
...
(1, 'Conditions Incase of Cancellations:', 'Cancellation of tickets with discounts will follow the above procedure. However, cancellation charges will be calculated based on the basic fare payable by the passenger. The refund amount will be the actual fare collected minus the cancellation fee.'),
(2, '', 'Bridge fees, user fees, toll fees, entry fees, and similar charges will be fully refunded.'),
(3, '', 'For ticket cancellations, the cancellation fee is calculated based on the applicable journey fare.'),
(4, '', 'Partial cancellation is possible.\r\n\r\n\r\n\r\n\r\n\r\n\r\n'),
(5, '', 'Partial cancellations will be refunded promptly.');
...
(1, 'Terms & Conditions:', 'To avail of the offer, the customer must enter the correct promo code GO50.'),
(2, '', 'The offer is valid only for the bus service.'),
(3, '', 'The offer is valid for both one-way and return bus bookings.'),
(4, '', 'The discount will be applied instantly to the booking amount during the transaction.'),
(5, '', 'The offer is valid for bookings made on Teerdha\'s app (both Android & iOS), PWA and desktop platforms.'),
(6, '', 'If the customer cancels the travel service purchase after the discount has been credited, Teerdha will deduct the discount amount from the refund, and cancellation charges will apply.'),
(7, '', 'In the case of partial cancellation, the offer becomes void if the revised booking amount no longer qualifies for the discount or cashback. The offer will then be adjusted accordingly based on the new booking amount.'),
(8, '', 'In case of full cancellation, the offer stands void and the customer will not be eligible for discount.'),
(9, '', 'This offer cannot be combined with any other offer from Teerdha.'),
(10, '', 'The user agreement and privacy policy of Teerdha shall apply.'),
(11, '', 'Teerdha reserves the right, at any time and without prior notice or liability, to add, alter, modify, change, or vary any of these terms and conditions, or to replace, in whole or in part, this offer with another offer, whether similar or not, or to extend or withdraw it altogether.'),
(12, '', 'Teerdha shall not be liable for any loss or damage arising from a force majeure event.'),
(13, '', 'For any card-related claims, the customer should approach the relevant bank, as Teerdha will not entertain such claims.'),
(14, '', 'Any disputes arising out of or in connection with this offer shall be subject to the exclusive jurisdiction of the competent courts in Delhi.'),
(15, '', 'Teerdha is the sole authority for interpreting these terms.');
...
(1, 'What you will get?', 'Use the code HOLIDAY20.', ''),
(2, '', 'Customers can save ₹2000 per person and receive a 20% discount on bus tickets.', ''),
(3, 'How do you get it?', 'To avail of the discounts, users must book bus tickets for their preferred holiday tour using the promo code: HOLIDAY20.', ''),
(4, '', 'Use the code to get a 20% discount up to ₹2000, plus ₹100 cashback on bus ticket bookings.', ''),
(5, '', 'Teerdha (HOLIDAY20) is applicable for a minimum ticket value of ₹5000.', ''),
(6, '', 'All our new and existing customers can take advantage of this offer.', ''),
(7, '', 'The offer is valid for bookings made on Teerdha\'s website, mobile site, and more.', ''),
(8, 'What else do you need to know?', 'This offer cannot be combined with any other promotional offers.', ''),
(9, '', 'The Teerdha offer is applicable across all channels.', ''),
(10, '', 'Teerdha cashback will be credited to the Teerdha wallet within 48 working hours after the date of the journey.', ''),
(11, '', 'The offer cash is valid for 6 months from the date it is credited to the wallet. After this period, it will expire and cannot be used.', ''),
(12, '', 'If a partial or full cancellation occurs, the offer will become invalid, and any discounts will be removed before processing refunds.', ''),
(26, '', '', 'images/HOLIDAY20.png'),
(27, 'Conditions Incase of Cancellations :', 'Cancellation is subject to the cancellation policy of the respective ticket.', ''),
(28, '', 'Partial cancellation is permitted.', ''),
(29, '', 'Partial cancellations will be refunded promptly.', ''),
(30, '', 'We allow cancellations of current tickets up to five hours before the bus departs from its starting point. Please note that this time is separate from the boarding time printed on your booking.', ''),
(31, '', 'Bookings made through this site are eligible for cancellation only via the Cancellation Form on this site. If an e-ticket was booked through an agent, please contact the respective agent for cancellations.', ''),
(32, '', 'A ticket that has been transferred cannot be transferred or canceled again.', ''),
(33, 'Terms & Conditions :', 'Sure, here are some typical terms and conditions for the bus booking offer:', ''),
(34, '', 'Verification: The Teerdha offer is valid only for logged-in users who verify their mobile number with an OTP (one-time password).', ''),
(35, '', 'Validity: This offer is valid from May 1, 2024, to June 1, 2024.', ''),
(36, '', 'Eligibility: The offer is open to individuals aged 18 and above.', ''),
(37, '', 'Requirement: To qualify for the offer, customers must book through Teerdha.', ''),
(38, '', 'Offer Details: The offer includes a flat 20% discount, which may vary depending on the holiday package.', ''),
...
(1, '', '', 'images/OFFER12..png'),
(2, 'What do you get?', 'Applicable to all users for ticket bookings.', ''),
(3, '', 'Users will receive a minimum of 15% off on bus tickets.', ''),
(4, 'How do you get it?', 'Get 15% off your bus ticket booking! Available to all credit card holders.\r\n\r\n\r\n', ''),
(5, '', 'To book your ticket, use the code: OFFER12.', ''),
(6, '', 'The discount coupon code is valid for bus bookings.\r\n\r\n\r\n\r\n\r\n\r\n\r\n', ''),
(7, '', 'The discounted amount will be deducted from the total amount payable.', ''),
(8, '', 'The offer is valid for bookings made on Teerdha\'s website, mobile site, and Android and iOS apps.', ''),
(9, '', 'All our new and existing customers can take advantage of this offer.', ''),
(10, 'What else do you need to know?', 'Changes to names are not allowed.', ''),
(11, '', 'The offers will be calculated on the base fare.', ''),
(12, '', 'In the case of partial or full cancellation, the offer will be void, and the discount will be removed before processing the refunds.', ''),
(13, '', 'This offer is exclusive to bookings made with valid promo codes.', ''),
(14, '', 'The offer cannot be combined with any other promotional offers.', ''),
(26, 'Conditions Incase of Cancellations :', 'If tickets are submitted at least 12 hours before the bus departure, a refund will be issued after deducting 10% of the ticket amount.', ''),
(27, '', 'If tickets are submitted within 12 hours of the bus departure, a refund will be issued after deducting 25% of the ticket amount.', ''),
(28, '', 'If tickets are submitted within 2 hours after the bus departure, a refund will be issued after deducting 75% of the ticket amount.', ''),
(29, '', 'If tickets are submitted more than 2 hours after the bus departure, no refund will be issued.', ''),
(30, '', 'The reservation or handling charges, if any, are non-refundable.', ''),
(31, 'Terms & Condition:', 'Teerdha is the sole authority for interpreting these terms.', ''),
(32, '', 'To avail of the offer, the customer must enter the correct deal code, OFFER12, in the \'Deal Code\' field.', ''),
(33, '', 'The discount will be applied instantly to the booking amount during the transaction.', ''),
(34, '', 'The offer is valid only for bus bookings.', ''),
(35, '', 'Travel agents are excluded from this offer.', ''),
(36, '', 'The offer is valid for both one-way and return bus bookings.', ''),
(37, '', 'If the customer cancels the travel service purchase after the discount has been applied, Teerdha will deduct the discount amount from the refund, and cancellation charges will apply.', ''),
(38, '', 'Additionally, Teerdha will enforce the standard booking and privacy policies found at www.teerdha.com.', ''),
(39, '', 'Teerdha reserves the right, without prior notice, liability, or explanation, to adjust, amend, or replace all or part of these terms and conditions. This includes the option to substitute this offer with another, whether similar or not, or to extend or withdraw it entirely.', ''),
(40, '', 'In the event of any dispute, the courts in New Delhi will have jurisdiction.', ''),
...
(2, '', 'This offer is valid on bookings made from April 20th to April 31st, 2024.', 'images/bank_end.png'),
(3, '', 'Users get 40% cashback up to Rs. 1000 on bus ticket bookings.', ''),
(4, '', 'Minimum order value: Rs. 500.', ''),
(5, '', 'All our new and existing customers can avail themselves of this offer.', ''),
(6, '', 'The coupon code is valid only for bus bookings.', ''),
(7, '', 'The offer is valid for bookings made on Teerdha\'s website, mobile site, and Android and iOS apps.', ''),
(8, 'Steps To Redeem The Bus Offer:', 'Open the Teerdha app.', ''),
(9, '', 'Scroll through the app and go to the \'Ticket Booking\' section.', ''),
(10, '', 'Click on \'Bus Tickets\' and select your itinerary according to your travel plan.', ''),
(11, '', 'Enter the \'Unique Coupon Code\' in the promo code section and click \'Apply\'.', ''),
(12, '', 'Proceed to the payment page and complete the transaction using ICICI Bank Net Banking or other available payment methods.', ''),
(13, 'What else do we need to know?', 'Bookings made using ICICI Bank will be eligible for the discount.', ''),
(14, '', 'This offer is valid for transactions made through mobile wallets, UPI, debit/credit cards, cash, and other payment methods.', ''),
(15, '', 'The offer cannot be combined with any other promotional offers.', ''),
(16, '', 'The offers will be calculated on the base fare.', ''),
(17, '', 'Only bookings with a valid promo code will be eligible for this offer.', ''),
(18, '', 'The offer is valid on bus bookings made through Teerdha.', ''),
(19, '', 'In the case of partial or full cancellation, the offer will be void, and the discount will be removed before processing the refund.', ''),
(20, '', 'Booking via SMS is free of charge. You will only need to pay the standard charges applicable for internet bookings.', ''),
(21, 'Terms and Conditions:', 'The offer is applicable only to transactions made via ICICI Net Banking.', ''),
(22, '', 'An instant discount will be provided to the customer at the time of booking.', ''),
(23, '', 'The offer will be applicable every Thursday during the offer period for transactions made via Net Banking only.', ''),
(24, '', 'An instant discount will be calculated on the total bus fare, which includes the base fare and tax (excluding ancillaries, insurance, and convenience fees).', ''),
(25, '', 'The following transactions will not qualify for meeting the spend criteria: ATM cash withdrawals, fee payments, transactions that are unsuccessful or cancelled/rejected by ICICI Bank, transactions followed by partial or full reversals, or transactions cancelled by the net banking user.', ''),
(26, '', 'In all matters relating to this offer, the decision of ICICI Bank shall be final and binding.', ''),
(27, '', 'If a customer uses reward points partly for the order, they will be eligible for the instant discount only if the sum of the amount paid through Net Banking and the value of the discount availed is greater than or equal to the minimum transaction value required for the offer.', ''),
(28, '', 'In the case of partial or full cancellation, the offer will be void, and the customer will not be eligible for the discount.', ''),
(29, '', 'In the case of cancellation of a booking purchased using a voucher or coupon code, the discount provided will be deducted from the refund amount as per the eligibility of the offer.', ''),
(30, '', 'The offer is not available where prohibited and/or on products or services for which such offers cannot be provided for any reason whatsoever.', ''),
(31, '', 'ICICI Bank and the service provider reserve the right to disqualify users from the benefits of the offer if any fraudulent activity is identified in connection with availing the benefits under the offer.', '');
...
(1, 'images/ayyodhyaaaa.png', 'Ayodhya Travel Guide.', 'Upto Rs.500 off on Bus Bookings.', 'Discount: 5% offer.', 'Valid Until: Every Fri,Sat,Sun.', 'BUSWEEKENDS', '/bus_main1/'),
(2, 'images/steal_the_deals.png', 'Steal the Deal.', 'Save Upto Rs.300 on Bus Bookings.', 'Discount: Get 50% Cashback.', 'Valid Until: Limited Period.', 'GO50', '/bus_main2/'),
(3, 'images/plan_your_trip_with_us.png', 'Plan your Trip With Us!', 'Offer on Festival Save Upto Rs.900.', 'Discount 30% offer.', 'Valid Until: February 25, 2024.', 'FESTIVALBUS', '/bus_main3/'),
(4, 'images/Travellings_in_India_1.png', 'Travellings in India?', 'Get FLAT Rs. 250 OFF on Buses.', 'Discount: 15% offer.', 'Valid Until: Limited Period.', 'SPECIAL25', '/bus_main4/'),
(5, 'images/New_user_1.png', 'New User Offer!', 'Upto Rs.210 off on First Booking.', 'Discount: 20% offer.', 'Valid Until: All Days Except Monday.', 'FIRSTBUS', '/bus_main5/'),
(6, 'images/MEGA_DEALS_3.png', 'Mega Deals on Booking!', 'Applicable For All Users FLAT Rs.100.', 'Discount: 10% offer.', 'Valid Until: Limited Period Offer.', 'BUSDAY', '/bus_main6/'),
(7, 'images/deal_of_the_day.png', 'Deal of the Day.', 'Enjoy Different Deals Each Day.', 'Discount: Minimum 10% offer.', 'Valid until: Only Sunday, Monday.', 'EASEDAY', '/bus_main8/'),
(8, 'images/special_offer_of_the_week_1.png', 'Special Offer of the Week.', 'Flat ₹120 offer + 100 Cashback.', 'Discount: 12% offer.', 'Valid until: Limited Time Period.', 'WEEKDAY', '/bus_main9/'),
(9, 'images/travel_party_1.png', 'Travel Party.', 'Upto 15% on all Bus Booking.', 'Discount: 15% offer.', 'Valid Until: Only this month.', 'OFFER12', '/bus_main11/'),
(10, 'images/ganesha_offer.png', 'Ganesha Offer !', 'Upto ₹500/-* on Bus Tickets.', 'Discount: Get Instant discount.', 'Valid Until: Limited period.', 'FEST24', '/bus_main13/'),
(11, 'images/Bank_offer.png', 'Bank Offer !', 'Grab Upto ₹1000/-* on Bus Tickets.', 'Discount: Get 40% offer.', 'Valid Until: Limited period.', 'ICICITD', '/bus_main14/'),
(12, 'images/Holiday_packages.png', 'Holiday Packages !', 'Save Upto ₹2000 Per Person.', 'Discount: 20% offer.', 'Valid Until: Limited period.', 'HOLIDAY20', '/bus_main15/'),
(13, 'images/Ride_more_save_more_2.png', 'Ride More Save More!', 'Instant Discount ₹300 on Bus Booking.', 'Discount: 8% offer.', 'Valid until: Limited Time Period.', 'RIDE10', '/bus_main7/');
...
(1, 'What do you get?', 'Users will receive a minimum discount of 8% on bus tickets.', ''),
(2, '', 'Get an instant discount of ₹300 on bus bookings.', ''),
(3, 'How to avail offer ?', 'Get an 8% discount.', ''),
(4, 'How do you get it?', 'To avail the offers, users must book bus tickets to their preferred destination using the promo code: RIDE10.', ''),
(5, '', 'This offer is valid for a limited time.', ''),
(6, '', 'All our new and existing customers can take advantage of this offer.', ''),
(7, '', 'The promo code is valid for bus bookings.', ''),
(8, '', 'The offer is valid for bookings made on Teerdha\'s website, mobile site, and Android and iOS apps.', ''),
(9, 'What else do you need to know?', 'This offer is exclusive to bookings made with a valid promo code.\r\n', ''),
(10, '', 'The offers will be calculated based on the base fare.', ''),
(11, '', 'This offer cannot be combined with any other promotional offers.', ''),
(12, '', 'If a partial or full cancellation occurs, the offer will become invalid, and any discount will be removed before processing refunds.', ''),
(13, '', 'Name changes are not allowed.', ''),
(24, '', '', 'images/Ride10.png'),
(25, 'Conditions Incase of Cancellations :', 'If tickets are canceled more than 12 hours before the bus departure, a refund will be issued after deducting 10% of the ticket amount.\r\n\r\n\r\n\r\n', ''),
(26, '', 'If tickets are canceled within 12 hours of the bus departure, a refund will be issued after deducting 25% of the ticket amount.', ''),
(27, '', 'If tickets are canceled within 2 hours after the bus departure, a refund will be issued after deducting 75% of the ticket amount.', ''),
(28, '', 'If tickets are canceled more than 2 hours after the bus departure, no refund will be issued.', ''),
(29, '', 'Reservation and handling charges, if any, are non-refundable.', ''),
(30, 'Terms & Conditions :', 'The offer is valid for online and mobile bookings.', ''),
(31, '', 'The discounted amount will be subtracted from the total payable amount.', ''),
(32, '', 'One promo code can be used by a user twice during the offer period.', ''),
(33, '', 'Enjoy your booking and happy travels!', ''),
(34, '', 'Teerdha reserves the right, without prior notice, liability, or explanation, to adjust, amend, or replace all or part of these terms and conditions. This includes the option to substitute this offer with another, whether similar or not, or to extend or withdraw it entirely.', ''),
(35, '', 'If there is any misuse or abuse of the offer, Teerdha reserves the right to deny the offer to customers.', ''),
...
(1, 'How to avail Offer?', 'Get a 15% discount.'),
(2, '', 'This offer is valid for a limited time.'),
(3, '', 'The discount coupon code is valid for bus bookings.'),
(4, '', 'The discount amount will be deducted from the total payable amount.'),
(5, '', 'All our new and existing customers can take advantage of this offer.');
...
(1, '', 'images/travellingsindia.png', 'Coupon Code: SPECIAL25');
...
(1, 'Conditions Incase of Cancellations:', 'In case of a partial cancellation, the seat number of the passenger who will not be traveling must be canceled.'),
(2, '', 'In case of partial cancellations, if the number of passengers after cancellation falls below four, the group discount for all seats will be withdrawn.'),
(3, '', 'In case of cancellation of the onward journey ticket, the discount on the return journey ticket will be withdrawn.'),
(4, '', 'Passengers are requested to check the availability of counters at the service origin points and the times when trip sheets are generated to ensure they have adequate time for ticket cancellation.'),
(5, 'Terms & Conditions:', 'The offer is valid for bookings made on Teerdha\'s app (both Android and iOS), PWA, and desktop platforms.'),
(6, '', 'Teerdha\'s user agreement and privacy policy shall apply.'),
(7, '', 'For any card-related claims, the customer must approach the relevant bank, and Teerdha will not entertain such claims.'),
(8, '', 'Teerdha reserves the right, at any time and without prior notice or liability, to add, alter, modify, change, or vary any of these terms and conditions, or to replace this offer, in whole or in part, with another offer—whether similar or not—or to extend or withdraw it altogether.'),
(9, '', 'This offer cannot be combined with any other offers from Teerdha.'),
(10, '', 'Any disputes arising out of or in connection with this offer shall be subject to the exclusive jurisdiction of the competent courts in Delhi.'),
(11, '', 'Teerdha shall not be liable for any loss or damage resulting from force majeure.'),
(12, '', 'Teerdha is the sole authority for interpreting these terms.'),
(13, '', 'In addition, Teerdha’s standard booking, cancellation, and privacy policies will apply.'),
(14, '', 'Travel agents are excluded from this offer.');
...
(1, 'images/splofferoftheweek.jpg', 'Offer Details', 'Offer', 'Promocode', 'Flat ₹120 offer + 100 cashback & Discount : 12% offer', 'WEEKDAY', '', ''),
(2, '', '', '', '', '', '', 'What do you get?', 'Users will receive a flat ₹120 off, ₹100 cashback, and a 12% discount on bus tickets.'),
(3, '', '', '', '', '', '', 'How do you get it?', 'To avail the discounts, users must book bus tickets for their preferred destination using the promo code: WEEKDAY.'),
(4, '', '', '', '', '', '', '', 'All our new and existing customers can take advantage of this offer.'),
(5, '', '', '', '', '', '', '', 'The promo code is valid for bus bookings.'),
(6, '', '', '', '', '', '', '', 'The offer is valid for bookings made on Teerdha\'s website, mobile site, and Android and iOS apps.'),
(7, '', '', '', '', '', '', 'What else do you need to know?', 'The offer cannot be combined with any other promotional offers.'),
(8, '', '', '', '', '', '', '', 'The offers will be calculated on the base fare.'),
(9, '', '', '', '', '', '', '', 'This offer is exclusive to bookings made with a valid promo code.'),
(22, '', '', '', '', '', '', 'Conditions Incase of Cancellations:', 'The cancellation will be processed according to the cancellation policy of the respective ticket.'),
(23, '', '', '', '', '', '', '', 'Partial cancellation is possible.'),
(24, '', '', '', '', '', '', '', 'Partial cancellations will be refunded promptly.'),
(25, '', '', '', '', '', '', '', 'Teerdha reserves the right to change the cancellation policy at any time without prior notice.'),
(26, '', '', '', '', '', '', '', 'Bookings made on this site can be canceled using the Cancellation Form on this site only. If an e-ticket is booked through an agent, please contact the respective agent for cancellations.'),
(27, '', '', '', '', '', '', '', 'Upon cancellation, the refund will be credited to the original payment method within three to ten working days.'),
(28, '', '', '', '', '', '', '', 'We allow cancellations of current tickets up to five hours before the bus departs from its starting point. This time should not be confused with the boarding time printed on your booking.'),
(29, '', '', '', '', '', '', '', 'A ticket once transferred cannot be transferred or canceled again.'),
(30, '', '', '', '', '', '', 'Terms & Conditions :', 'In the event of any misuse or abuse of the offer, Teerdha reserves the right to deny the offer to customers.'),
(31, '', '', '', '', '', '', '', 'Teerdha has absolute authority over the interpretation of these terms.'),
(32, '', '', '', '', '', '', '', 'The offer is valid for both online and mobile bookings.'),
(33, '', '', '', '', '', '', '', 'The discounted amount will be subtracted from the total amount payable.'),
(34, '', '', '', '', '', '', '', 'A user can use one promo code twice during the offer period.'),
(35, '', '', '', '', '', '', '', 'Enjoy your booking and happy travelling.'),
(36, '', '', '', '', '', '', '', 'Additionally, Teerdha’s standard booking and privacy policies, as outlined at www.teerdha.com, will apply.'),
(37, '', '', '', '', '', '', '', 'In the event of any dispute, the courts in New Delhi will have jurisdiction.'),
(38, '', '', '', '', '', '', '', 'Teerdha reserves the right, without prior notice, liability, or explanation, to adjust, amend, or replace all or part of these terms and conditions. This includes the option to substitute this offer with another offer, whether similar or not, or to extend or withdraw it entirely.'),
(39, '', '', '', '', '', '', '', 'Teerdha shall not be liable for any loss or damage resulting from force majeure.');
...
(1, 'Ayodhya Travel Guide', 'images/ayodhya_LJSNPni.png', 'Limited Time Offer', 'Apply the coupon code BUSWEEKENDS to save Rs. 500 on your booking.'),
(3, '', '', '', 'The offer is also valid for payments made with select credit and debit cards.'),
(4, '', '', '', 'Users must be logged in to Teerdha to avail of the offer.'),
(5, '', '', '', 'The offer is valid every Friday, Saturday, and Sunday.'),
(6, '', '', '', 'The offer cannot be combined with any other offer.'),
(7, '', '', '', 'Users will receive ₹10 to ₹100 cashback when completing a payment at select shops using Paytm.'),
(8, '', '', '', 'Users must make a payment of ₹50 or more to qualify for cashback.\r\n'),
(9, '', '', '', 'The offer can be availed only once during the campaign period.'),
(10, '', '', '', 'After making the eligible payment, users will receive a scratch card.'),
(11, '', '', '', 'By scratching this scratchcard, users can receive cashback.'),
(12, '', '', '', 'If users don’t scratch the card immediately after making a payment, they may not be eligible for cashback.'),
(13, '', '', '', 'They have the option to do so by accessing the cashback & offers section.'),
(14, '', '', '', 'The offer also applies to payments made through Paytm at selected merchants registered with Paytm.'),
(15, '', '', '', 'For UPI payments, users need to use their own Paytm-registered UPI to receive cashback.'),
(16, '', '', '', 'Teerdha reserves the right to invalidate any transaction.'),
(17, '', '', '', 'Teerdha reserves the right to discontinue the offer at any time without prior notice or accepting any liability.'),
(19, '', '', 'Conditions Incase of Cancellations:', 'A cancellation fee will be deducted from the total amount collected.'),
(20, '', '', '', 'Cancellation fees (as a percentage of the fare refund) are based on the time of cancellation relative to the departure time of the service at the boarding location.'),
(21, '', '', '', 'For the cancellation of tickets, the cancellation fee is calculated on the applicable journey fare.'),
...
(1, 'Terms and Conditions', 'The offer is valid for bookings made on Teerdha\'s app (both Android and iOS), PWA, and desktop platforms.\r\n\r\n\r\n\r\n\r\n\r\n\r\n'),
(2, '', 'This offer cannot be combined with any other offer from Teerdha.\r\n\r\n\r\n\r\n\r\n\r\n\r\n'),
(3, '', 'Teerdha reserves the right, at any time, without prior notice or liability and without assigning any reason whatsoever, to add, alter, modify, change, or vary all of these terms and conditions or to replace, wholly or in part, this offer with another offer, whether similar to this one or not, or to extend or withdraw it altogether.'),
...
(7, '', 'Disputes, if any, arising out of or in connection with this offer shall be subject to the exclusive jurisdiction of the competent courts in Delhi.'),
(10, '', 'Teerdha is the sole authority for interpreting these terms.'),
(11, '', 'Teerdha shall not be liable for any loss or damage arising from force majeure.');
...
(1, 'Here\'s what you need to know about Teerdha.', 'Teerdha is the best platform for booking bus tickets online. Serving customers across the country and expanding to more countries, Teerdha is trusted by over 17 million users. It offers an easy, fast, and secure way to book affordable bus tickets. Simply select your origin, destination, and departure date to quickly find a variety of buses. You can book a bus according to your preferred schedule, choose your pick-up and drop-off locations, select your desired bus type, and complete your booking online with just a few clicks!'),
(2, 'Why choose Teerdha for your bus booking?', 'As a leading player in online bus bookings in India, Teerdha offers the lowest fares, exclusive discounts, and a seamless booking experience. Whether on desktop or mobile, the user-friendly interface allows you to complete your booking with just a few clicks.'),
(3, 'Book bus tickets online at the lowest prices.', 'With Teerdha, travelers can book bus tickets online at the lowest fares. You can select your preferred bus for booking, whether it’s a private bus or an SRTC (State Road Transport Corporation) bus. Teerdha offers a variety of options, from choosing your pickup point to selecting your seat, including luxury buses with sleeper berths. The platform provides a wide range of buses such as Mercedes, Volvo, AC luxury, Deluxe, Sleeper, Express, and other private options. Payment is convenient with options for debit/credit cards or net-banking. Additionally, you can cancel your bus tickets online if your travel plans change. Book directly at teerdha.com and travel with confidence.'),
(4, 'Open 24/7 for reservations', 'This is the most important reason to book bus tickets online: you can book anytime from anywhere. You can also use your Teerdha bus offer code anytime to avail a discount on your bus booking. When you book through a travel agency or agent, you have to pay an additional commission fee, but if you book online, you avoid this fee. Online booking also informs you of various bus ticket offers, allowing you to get discounts on your bus booking.'),
(5, 'Advantages of booking with Teerdha.', 'Teerdha buses are renowned for their outstanding safety, comfort, and environmental sustainability, making them the preferred choice for both passengers and operators. They prioritize safety with the latest features, are committed to reducing their carbon footprint, and are designed for maximum fuel efficiency with minimal emissions. Additionally, their AC buses offer a relaxing travel experience, even in humid and hot conditions, which is especially important for long-distance journeys.'),
(6, 'More bookings, fewer cancellations!', 'Managing bookings manually involves endless back and forth, with the constant risk of cancellations or no-shows. Online booking with Teerdha can lift that weight from your shoulders, making the entire process effortless and efficient. Additionally, automated reminders sent to customers\' phones and emails can further increase the chances of them showing up.\r\n\r\n\r\n\r\n\r\n\r\n\r\n'),
(7, 'Secure and fast payments!', 'In simple terms, an online booking system will put money in your pocket quicker and can detect fraud and resolve disputes. Often, we face the challenge of customers creating bookings but not showing up, especially if no prepayment is involved. With the Teerdha booking system, you can opt for a partial or full upfront deposit to secure your bookings. An automated system will make handling payments seamless with a secure payment gateway. In the event of a no-show, it even allows you to keep a certain amount as compensation, minimizing your losses.'),
(8, 'No more human errors', 'Mistakes are inevitable with manual processes—an 8 that looks like a 6 or a missing note from your notepad can cost you money or a potential customer. An automated tool like Teerdha\'s online reservation system will eliminate these errors. While the system may not detect every mistake made by a customer, it ensures that you are protected from errors on your end.'),
(9, 'Say hello to the new Teerdha Application!', 'Customizing the Teerdha Online Booking system to suit your business needs takes time and effort from both your end and the Teerdha support team. However, once this work is completed, the system will offer all the features of a Teerdha Bus Booking Application, delivering top-notch personalized service to your customers as a Tour and Activity Service provider. While you might still need customer care for certain special scenarios, as you continue to customize the system for these unique cases, customer support queries will become increasingly rare.\r\n\r\n\r\n\r\n\r\n\r\n\r\n');
...
(2, 'Airport Travel Made Easy', '/cab_update/2'),
(3, 'Anytime, Anywhere Travel', '/cab_update/3'),
(4, 'Get Rs.100 offer', '/cab_update/4'),
(5, 'Get 10% Discount', '/cab_update/5'),
(6, 'Family Travel Savings', '/cab_update/6'),
(7, 'paytm cashback', '/cab_update/7'),
(8, 'Ride More, Save More', '/cab_update/8');
...
(1, 'Why do we choose Teerdha for booking cabs?', 'With the rise of technology, booking a cab online has never been easier. It provides a wide range of benefits that can make your travel experience smoother and more enjoyable.You can book a cab quickly and easily from the comfort of your home, using a mobile app or website. No longer waiting on hold or struggling to communicate over the phone.We are the one revolutionizing easy and simple online taxi booking in India. We are committed to providing 100% customer-satisfactory rides along with ensuring safety.'),
(2, 'Is Teerdha cabs available 24/7 ?', 'The right way to get through your everyday travel needs. Teerdha cabs are available 24/7. So, you can book at anytime and travel in a moment. As cab services are available 24/7, you can enjoy a cab ride at any time or during transportation emergencies. Whether you are traveling to a new place or in emergency situations, cab services will help you reach your destination safely and on time.'),
(3, 'Can Teerdha track your cab live location ?', 'When you book your Teerdha ride, you’re assigned a driver, whose confirmation comes to you with a ride tracking link.The same link can be used to track your driver. And using the same link, even without the Teerdha app, your parents & loved ones can track your ride movements.There is no limitation to the number of people who can use the GPS tracking link.'),
(4, 'What kind of payment methods are available ?', 'These platforms offer a range of simple and secure payment methods, including cash, credit cards, and digital wallets.  This eliminates the need to carry cash, ensuring a hassle-free experience from start to finish.People can view the fare and pay for the ride in advance, which ensures transparency and eliminates any confusion or disagreements.'),
(5, 'Visit Teerdha.com for more info ', ' Book cabs for your daily routines and also for holiday round trips.Here you can tailor your trip from end-to-end by scouring for suitable cabs and making your cab booking before proceeding with your hotel bookings.Taxi fares are very reasonably priced. They are just little more than bus or train expenses. However, the comfort and personal space you get in a taxi is not available on the bus or train.');
...
(2, '', 'How do You Get ?', 'Use the code \"EASY25\" during the booking process to avail of the offer upto 25% discount.', 'The discount will be automatically applied to your total booking amount once you enter the code.', 'Easily book our services through our Teerdha website or mobile app.', 'Receive instant confirmation of your booking along with details of your cab and driver.', '', '', '', '', '', '', '', ''),
...
(2, '', '', '', 'What Users Get ?', 'A 30% discount on cab rides specifically tailored for family travel.', 'Convenient and affordable travel options for families.', 'Exclusive savings are available only with the promo code \"FAMILYFUN30\".', 'Opportunity to create memorable family moments without breaking the budget.', '', '', '', '', '', '', '', ''),
...
(2, '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(3, 'images/Frame_4.jpg', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(4, '', 'How do you get it ?', 'To avail of this offer, you need to use the code MAKARA20 during your booking process.', '', '', '', '', '', '', '', '', '', '', ''),
(5, '', 'What else do you need to know ?', 'This offer is valid only for your first booking.', '', '', '', 'The discount will be applied instantly upon entering the code MAKARA20 during the booking process.', 'This offer may have certain terms and conditions, such as a minimum booking amount, validity period etc. Make sure to check them before availing the offer.', '', '', '', '', '', ''),
(6, '', 'Terms and Conditions', '', '', '', '', 'The discount is applicable only when the code MAKARA20 is used during the booking process.', 'A minimum booking amount may be required to get the discount.', 'This offer is subjected to availability and may be withdrawn at any time without prior notice.', 'This offer cannot be combined with any other promotions or discounts.', 'Other terms and conditions may apply. Please refer to the specific offer details for more information.', '', '', '');
...
(1, 'Domestic Flights Offer\n', 'GOYES', 'Flat 12% Instant Discount (upto Rs. 1,500).', 'Every Thursday and Saturday'),
...
(1, '', 'images/yesbank_PtebLFX.png', '', 'Flat 12% OFF*', 'YES Bank Credit Cards');
...
(8, 'How do you get it?', 'The customer must input E-Coupon in the E-Coupon field, as indicated in the above table, In order to take advantage of the offer.'),
...
(19, 'Other Terms & Conditions:', 'Discount offer is only valid on the eligible BINs shared by YES Bank. If the BIN series of the card does not match with the one provided by YES Bank to Teerdha, then the cardholder should approach YES Bank.'),
...
(5, 'How much luggage can i carry on my flight?', 'As per regulations, please ensure that both your checked bags and cabin baggage comply with the specified security requirements.'),
(6, 'Which flight ticket booking could be better?', 'My suggestion is that the economy and business class flight tickets are better.'),
(7, 'Can I pay for the flight ticket booking later?', 'No, the entire payment for reserving the airline tickets was made during the booking process.'),
(8, 'How many tickets can be booked at once?', 'You can book flight tickets for up to 9 persons on a single account.'),
(9, 'Anything I want to show as identification when I check in?', 'During the check-in process, customers are required to present a valid form of identification like a driving license or PAN Card.'),
...
(20, 'Axis Bank Offer', '/axis_offerapi/', '/axis_offer_update/4'),
(21, '', '/axis_termsapi/', '/axis_terms_update/2'),
(23, 'Axis Bank Offer', '/axis_termsapi/', '/axis_terms_update/2'),
(24, 'wertasdfgb', '/axis_termsapi/', '/axis_offer_update/4');
...
(1, 'Grab up to 12% OFF* on Flights.', 'USECODE: TRDKOTAK', 'images/KOTAK_atJJYwA.png', '', '/kotak/'),
(2, 'Enjoy Discounts on Flights with Axis Bank.', 'USECODE: TEDAXIS', 'images/TEDAXIS_1_8VzLDGp.png', '', '/axis/'),
(3, 'Book flights with 100% refund on cancellation.', 'USECODE: TRDDOM', 'images/buy.png', '', '/zerocancellation/'),
(4, 'Grab 12% OFF* on Yesbank Credit cards.', 'USECODE: TRDYB', 'images/TRDYB_cTYwj4y.png', '', '/yes_bank_offercard/'),
(5, 'Upto 2000/- on domestic flights.', 'USECODE: TRDHDFC', 'images/HDFCTED_1_6wh9PPe.png', '', '/hdfc_offer_card/'),
(6, 'Grab FLAT 10% OFF* on Domestic Flights.', 'USECODE: TRDSBI', 'images/TRDSBI_2b9dP4A.png', '', '/sbi/'),
(7, 'FLAT 12% OFF* on Domestic Flights.', 'USECODE: TRDICICI', 'images/icici_3_Z9arXO7.png', '', '/icic/'),
(8, 'New user offer on your 1st flight.', 'USECODE: TEDFB1', 'images/tedfb1.png', '', '/flight_offer_1');
...
(1, 'Grab up to 12% OFF* on Flights.', '/flight_update/1'),
(2, 'Enjoy Discounts on Flights with Axis Bank', '/flight_update/2'),
(3, 'Book flights with 100% refund on cancellation.', '/flight_update/3'),
(4, 'Grab 12% OFF* on Yesbank Credit cards', '/flight_update/4'),
(5, 'Upto 2000/- on domestic flights', '/flight_update/5'),
(6, 'Grab FLAT 10% OFF* on Domestic Flights.', '/flight_update/6'),
(7, 'FLAT 12% OFF* on Domestic Flights.', '/flight_update/7'),
(8, 'New user offer on your 1st flight.', '/flight_update/8');
...
(4, 'images/axis_nh8MF4T.png', 'Enjoy Huge Discounts on Flights with Axis Bank Debit/Credit Cards!', 'Promocode : TEDAXIS', '', ''),
(5, '', '', '', 'What do you get?', 'Customers of this offer will get an attractive discount on flight booking using Axis Bank credit or debit cards.\r\n'),
(6, '', '', '', 'How do you get it?', 'To enjoy discounts, users should domestic flights as per their preference and utilize the coupon code: TEDAXIS.'),
(7, '', '', '', '', 'Offer valid on flight bookings only.'),
(8, '', '', '', '', 'This offer is valid for transactions done an Axis Bank debit or credit card only.'),
(9, '', '', '', '', 'Both new and existing customers have the opportunity to benefit from this offer.'),
(10, '', '', '', '', 'The offer is valid for bookings made on Teerdha\'s website, mobile site, and Android & iOS apps.'),
(11, '', '', '', 'What else do you need to know?', 'A convenience fee will be applied as necessary.'),
...
(18, '', '', '', '', 'In addition, Teerdha standard booking and privacy policies on www.teerdha.com shall apply.'),
...
(1, '', 'media/axisbank_offerscard2.png', 'Axis bank domestic and international flight offers', 'Flat 20% off on domestic & flat 15% off on International flights with axis bank.'),
(2, '', 'media/axisbank_offerscard4.png', 'Get exclusive discounts on International flights', 'Get a flat 7% off up to INR 4500 on International flight booking with axis bank.'),
(3, '', 'media/axisbank_offerscard3.jpg', 'Axis bank flight booking offers', 'Get 10% instant discount on domestic and international flight booking.'),
(4, '', 'media/axisbank_offerscard5.png', 'Get exclusive discounts on domestic flights', 'Get a flat 8% off up to INR 1500 on domestic flight booking with axis bank.');
...
(1, 'images/firstbooking_PjSx8PU.jpg', 'Join Now to Receive a Discount on Your First Flight Ticket with Us');
...
(2, 'What do you get?', 'Minimum flight booking amount is RS.3000, then you will get a flat 10% discount.'),
(4, 'How will you  get?', 'To get this discount, users have to register/sign-up for booking flight tickets for their preferred destination by applying for a coupon code.'),
(5, 'How will you  get?', 'This offer is valid for a limited period.'),
(6, 'How will you  get?', 'Bookings made through the Teerdha website, the mobile site, and iOS and Android apps are eligible for the promotion.'),
(7, 'You need to know :', 'Customers under this offer will get up\nto Rs.750 on a flight.'),
...
(10, 'You need to know :', 'Bookings with the valid promo codes will only be eligible for this offer.'),
...
(13, 'You need to know :', 'To avail this offer customers needs to process his booking with their registered mail ID.'),
(14, 'You need to know :', 'In case of partial/full cancellation, the offer stands void and the discount will be rolled back before processing the refunds.'),
(15, 'You need to know :', 'Child / infant discount, date or flight change, refund charges, weekend surcharge, black out period, travel restrictions and flight restriction will also be applicable as per the fare rules.'),
...
(19, 'Terms and Conditions :', 'Teerdha is the sole authority for the interpretation of these terms.'),
...
(4, 'About the Offer', 'Enter the passenger details and select preferred payment methods: the Teerdha website, mobile website, Android apps, and iOS apps only. Get the best flight fares and existing offers on flight tickets when booking a tour  with Teerdha, plus more deals like the Travel Max sale, the Big Travel Sale, etc. Offer never-before-seen-before discounts that help you book flights at affordable rates and the best flight discounts with HDFC cardholders only. Every month, one existing offer is available through net banking.'),
(5, 'Terms and Conditions', 'This offer can\'t be combined with other offers.'),
...
(9, 'Terms and Conditions', 'Bookings must be made through UPI and online transactions to qualify for discounts.'),
(10, 'Terms and Conditions', 'Bookings for promotions are not refundable and non-transferable.'),
...
(2, 'About The Offer', 'images/icicibank2_mXwfKgZ.png', 'Book your domestic flight and get a flat 12% off on payments via ICICI Bank Creditcards.', 'TRDICICI', '', '');
...
(4, 'How to avail the offer?', 'You will get a flat 12% off  on your booking.'),
(5, 'Terms & Conditions:', 'If the cardholder doesn\'t receive the discount, he/she can claim for the same within 3 months from the booking date. In the event the cardholder fails to do so, he/she will not be eligible for any discount.'),
...
(7, 'Terms & Conditions:', 'This offer cannot be clubbed with any other offer from Teerdha.'),
(8, 'Terms & Conditions:', 'Minimum booking amount excluding ancillaries, Insurance, etc.'),
(9, 'Terms & Conditions:', 'Teerdha and ICICI Bank reserve the right, at any time, without prior notice and liability and without assigning any reason whatsoever, to add/alter/modify/change or vary all of these terms and conditions or to replace, wholly or in part, this offer by another offer, whether similar to this offer or not, or to extend or withdraw it altogether.'),
...
(12, 'Terms & Conditions:', 'Teerdha and ICICI Bank are the sole authorities for the interpretation of these terms.'),
...
(16, 'Terms & Conditions:', 'Teerdha and ICICI Bank shall not be liable for any indirect, punitive, special, incidental or consequential damages arising out of or in connection with the offer.'),
...
--
-- Table structure for table `booking_profiles`
--
...
--
-- Dumping data for table `booking_profiles`
--

INSERT INTO `booking_profiles` (`id`, `image`, `bio`, `email`, `mobile_number`, `user_id`) VALUES
(1, 'images/bus_x1BiwZe.jpg', '', 'reecha.arava@developtrees.com', '9878986780', 8);
...
--
-- Table structure for table `booking_sidebar_dashboard`
--

CREATE TABLE `booking_sidebar_dashboard` (
  `id` bigint(20) NOT NULL,
  `title` varchar(100) NOT NULL,
...
--
-- Dumping data for table `booking_sidebar_dashboard`
--

INSERT INTO `booking_sidebar_dashboard` (`id`, `title`, `url`, `icon`, `subdivision`) VALUES
(1, 'Flights offers', '/flight_offertb', '<i class=\"bi bi-airplane-fill\"></i>', 'Flights'),
(2, 'Flights Offers Details', '/flight_2ndpages', '<i class=\"bi bi-airplane-fill\"></i>', 'Flights'),
(3, 'Flights whychoose update', '/WhyChoose_home', '<i class=\"bi bi-airplane-fill\"></i>', 'Flights'),
(4, 'Flights faqsupdate', '/faq_home', '<i class=\"bi bi-airplane-fill\"></i>', 'Flights'),
(5, 'Buses offers', '/buses_offertb', '<i class=\"bi bi-bus-front-fill\"></i>', 'Buses'),
(6, 'Buses Offer Details', '/bus_2ndpages', '<i class=\"bi bi-bus-front-fill\"></i>', 'Buses'),
(7, 'Buses whychoose table', '/bus_whychoose_op', '<i class=\"bi bi-bus-front-fill\"></i>', 'Buses'),
(8, 'Buses faqstable', '/bus_faq_op', '<i class=\"bi bi-bus-front-fill\"></i>', 'Buses'),
(9, 'Cab offers', '/cabs_table_dashboard', '<i class=\"bi bi-taxi-front-fill\"></i>', 'Cabs'),
(10, 'Cab offers crud operations', '/cabs_table_2ndpagedb', '<i class=\"bi bi-taxi-front-fill\"></i>', 'Cabs'),
(11, 'Cabs whychoose table', '/cabs_whychoose', '<i class=\"bi bi-taxi-front-fill\"></i>', 'Cabs'),
(12, 'Cabs faqstable', '/cabfaq_home', '<i class=\"bi bi-taxi-front-fill\"></i>', 'Cabs'),
(13, 'Hotels offers', '/hotels_offertb', '<i class=\"bi bi-buildings-fill\"></i>', 'Hotels'),
(14, 'Hotels Offers Details', '/hotel_2ndpages', '<i class=\"bi bi-buildings-fill\"></i>', 'Hotels'),
(15, 'Hotel whychoose table', '/hotel_cardstb', '<i class=\"bi bi-buildings-fill\"></i>', 'Hotels'),
(16, 'Hotel faqstable', '/hotel_faqtab', '<i class=\"bi bi-buildings-fill\"></i>', 'Hotels');
...
(1, 'Safeguard yourself against last-minute plan changes with our ‘ZERO Cancellation’ feature on domestic flights. Buy now starting @ Rs. 199 ONLY and enjoy.', 'images/zero_8ZqXXuV.png', 'No Extra Charges on Cancellation.', '100% Money Back Guarantee on Cancellation.', 'images/no_mot.PNG', 'images/refu.PNG');
...
(7, 'How do you get it?', 'During the booking process, select \'ZERO Cancellation\' option by paying an additional fee starting from Rs.199/- per passenger & enjoy ZERO penalty in case you wish to cancel the booking.'),
...
(13, 'What else do you need to know?', 'Zero cancellation is only available for pure cancellations; date changes will not be accepted. Only full cancellations, that is, cancellations of every flight a certain traveler has scheduled for any or all passengers, are eligible for the waiver.'),
...
(1, 'Festive Offer', 'Get Rs.200 instant discount only your 1st booking!', 'images/festive_offer.JPG', 'MAKARA20', '/festive_main/'),
(2, 'Airport Travel Made Easy', 'Book our reliable cab services and save upto 25%', 'images/airport_travel.JPG', 'EASY25', '/easy_main/'),
(3, 'Anytime, Anywhere Travel', 'Get 5% off upto Rs.150 + 5% upto Rs.150 Cashback.', 'images/anytime_anywhere.JPG', 'ANYTIME24', '/anytime_main/'),
(4, 'Get Rs.100 offer', 'Get Rs.100 off on your next ride and travel conveniently!', 'images/save_on_your_next_ride.JPG', 'RIDE100', '/ride_main/'),
(5, 'Get 10% Discount', 'Enjoy a flat 10% discount on your cab bookings, upto Rs.150.', 'images/empcab10.JPG', 'EMTCAB10', '/rental_main/'),
(6, 'Family Travel Savings', 'Save 30% on cab rides with our family-friendly offers.', 'images/family_travel.JPG', 'FAMILYFUN30', '/familyfun_main/'),
(7, 'Paytm Cashback', 'Scan and pay using paytm and get upto  Rs.250 cashback .', 'images/paytm_42pbVnk.JPG', 'PAYTM25', '/paytm_card_main/'),
(8, 'Ride More, Save More', 'Enjoy a flat 15% discount on your cab bookings, upto Rs.150.', 'images/ride_more_save_more.JPG', 'OFFER15', '/offer15_main/');
...
(4, '', 'What Else You Need to Know?', 'The offer is valid for a limited time period.', '', '', '', 'Applicable on select cab services and routes.', 'Discount may vary based on the booking amount.', 'The code can be used only once per user.', 'The discount is non-transferable and cannot be exchanged for cash.', '', '', '', ''),
...
(13, 'Multiple Payment Options for Flight Booking:', 'You have the option of paying for multiple modes on your air ticket booking. The payment gateway offers you the option to pay with credit and debit Cards, Netbanking, EWallet, UPI whether you make full payment or on an EMI basis. This flexibility makes it easy to close your flight booking, and not make you feel restricted, such as when the mode of payment you have chosen is not listed in the options.');
...
(3, '2024-07-23 03:36:36.114148', '4', 'Arava', 3, '', 4, 5),
(4, '2024-07-23 03:36:36.269451', '6', 'prabha', 3, '', 4, 5),
(5, '2024-07-23 03:36:36.279676', '1', 'sanju', 3, '', 4, 5),
(6, '2024-07-23 03:36:36.313793', '3', 'swetha', 3, '', 4, 5),
(7, '2024-07-23 03:36:36.324411', '7', 'teerdha', 3, '', 4, 5),
(8, '2024-07-23 11:38:15.259734', '5', 'Rrr', 2, '[{\"changed\": {\"fields\": [\"Email address\"]}}]', 4, 5),
(9, '2024-07-23 11:54:48.504843', '2', 'Reecha', 3, '', 4, 8),
(10, '2024-07-31 04:19:42.672997', '1', 'Profiles object (1)', 1, '[{\"added\": {}}]', 134, 8),
(11, '2024-08-01 03:54:58.633630', '1', 'Profiles object (1)', 2, '[]', 134, 8),
(12, '2024-08-07 08:30:53.578914', '8', 'Developtrees', 2, '[]', 4, 8),
(13, '2024-08-07 08:31:10.310237', '1', 'Profiles object (1)', 2, '[]', 134, 8);
...
(133, 'booking', 'profile'),
(134, 'booking', 'profiles'),
(47, 'booking', 'sbiimage'),
(48, 'booking', 'sbioffer'),
(49, 'booking', 'sbiterms'),
(120, 'booking', 'sidebar'),
(132, 'booking', 'sidebar_dashboard'),
...
(67, 'booking', '0049_delete_dashboard_sidebar', '2024-06-24 09:42:16.638317'),
(68, 'booking', '0050_sidebar_dashboard', '2024-06-24 09:42:16.683142'),
(69, 'booking', '0051_profile', '2024-07-19 07:05:15.640037'),
(70, 'booking', '0052_profiles_delete_profile', '2024-07-30 12:50:42.263165');
...
('1jqsmc5849s61jiey3zlie750d0jgg1y', '.eJxVjMsOwiAQRf-FtSEwLY-6dO83kBkGpGogKe3K-O_apAvd3nPOfYmA21rC1tMSZhZn4cXpdyOMj1R3wHestyZjq-syk9wVedAur43T83K4fwcFe_nWpDPYqBTFEUEblbyPlL0e2A1TMpSZFUAaHIw-WgVo2BrIVmvLjiYj3h_o1DeZ:1swJjv:QwjdYDmHEVelgjHklfem2aXn82h9ZufHSsTAVORQROw', '2024-10-17 11:11:23.611909'),
('23or5rfxfbms7a7vcxj8w0udpxt7qpqv', '.eJxVjMsOwiAQRf-FtSEwLY-6dO83kBkGpGogKe3K-O_apAvd3nPOfYmA21rC1tMSZhZn4cXpdyOMj1R3wHestyZjq-syk9wVedAur43T83K4fwcFe_nWpDPYqBTFEUEblbyPlL0e2A1TMpSZFUAaHIw-WgVo2BrIVmvLjiYj3h_o1DeZ:1swa85:oNVcFG-_PzZYbnLqHjPdA2jcPFR8HwQ6jQF7CdL4F0I', '2024-10-18 04:41:25.201745'),
('2ds0unl6ojqguxyhwk79b36idnhfb608', '.eJxVjLEOwjAMRP8lM4riUCspIzvfENmJTQqolZp2Qvw7rdQBlhvuvbu3SbQuNa1N5jQUczFoTr8dU37KuIPyoPE-2TyNyzyw3RV70GZvU5HX9XD_Diq1uq1dOSOxh4jcqwCCgHgXt2Dti1AOyBm7CBo6dqoEKgqAWDwFymA-X_ZNOKw:1sTJpL:fc3si7l8doqGBGL6NFOnSfXmwUbGtD3Lg9WGCyS5r5s', '2024-07-29 11:25:07.552747'),
('34ruatavegbx59ch42inrprqp5f6gfs3', '.eJxVjMsOwiAQRf-FtSEwLY-6dO83kBkGpGogKe3K-O_apAvd3nPOfYmA21rC1tMSZhZn4cXpdyOMj1R3wHestyZjq-syk9wVedAur43T83K4fwcFe_nWpDPYqBTFEUEblbyPlL0e2A1TMpSZFUAaHIw-WgVo2BrIVmvLjiYj3h_o1DeZ:1ssza0:zpgAVtybQ7DftoE3P2Z77ZY0RACeRLXgHFMnuaIb-xE', '2024-10-08 07:03:24.285636'),
('43mz5i1jjektstv2du5w4crst4cf2cht', '.eJxVjEEOwiAQRe_C2pAOBQou3XsGMjCDVA0kpV0Z765NutDtf-_9lwi4rSVsnZcwkzgLLU6_W8T04LoDumO9NZlaXZc5yl2RB-3y2oifl8P9OyjYy7dG7QyDAQvgJpuVtxpw0JpAYbRjGtM0YsTBoPcqk00EzqgMWZGPzCDeH76FN5Q:1sLxEQ:nNvTW-41FyCjpxEFKg2dfEazg9jn7v9-CDfMlN_Pc_k', '2024-07-09 03:52:34.838059'),
('48iq3rtaav5q39ll3gl2pox877vll9rh', '.eJxVjDkOwjAUBe_iGlneY1PScwbrLw4OIEeKkwpxd4iUAto3M-8lMmxrzVsvS55YnEUSp98NgR6l7YDv0G6zpLmty4RyV-RBu7zOXJ6Xw_07qNDrt0bkhCNFMEZ5VdgW9A6DHyA4CN4nhcboSBYdeGu1iomDGZWigbQ1Vrw_8dk3WQ:1sWV6A:tGGLyKnGfKl1CLbsRPx9okU_hAejkHaaDind4xQs3yk', '2024-08-07 06:03:38.976228'),
...
('5byn0l60vics4wrxgowyz2i5mp7uh349', '.eJxVjDsOwyAQRO9CHSHAGJaU6X0GtMsnOIlAMnYV5e6xJRdJMc28N_NmHre1-K2nxc-RXRmwy29HGJ6pHiA-sN4bD62uy0z8UPhJO59aTK_b6f4dFOxlXytjo8pSSxB2EBaGIWuniZTICZQYnR0hSowakzIETpG0QmtHwYDdwz5fru82lw:1sdRUd:4dMiAhyeOzVOkn1wIpZoovnFAa2Ht9_dWkFAFlrUU6I', '2024-08-26 09:37:35.668318'),
('9b3axog8l9jygt9smiw3f8wsjm4as8o4', '.eJxVjLEOwjAMRP8lM4riUCspIzvfENmJTQqolZp2Qvw7rdQBlhvuvbu3SbQuNa1N5jQUczFoTr8dU37KuIPyoPE-2TyNyzyw3RV70GZvU5HX9XD_Diq1uq1dOSOxh4jcqwCCgHgXt2Dti1AOyBm7CBo6dqoEKgqAWDwFymA-X_ZNOKw:1sUec1:dEWDJ4J09DpKKK6KEidoMUBd1R2iM6P46wA2ivmEWpc', '2024-08-02 03:48:53.969698'),
('a61s92jg92azojjtcwapo2il9bymtc1h', '.eJxVjDkOwjAUBe_iGlneY1PScwbrLw4OIEeKkwpxd4iUAto3M-8lMmxrzVsvS55YnEUSp98NgR6l7YDv0G6zpLmty4RyV-RBu7zOXJ6Xw_07qNDrt0bkhCNFMEZ5VdgW9A6DHyA4CN4nhcboSBYdeGu1iomDGZWigbQ1Vrw_8dk3WQ:1sWpg4:lzuTi4XQVe1H1phIJWBVBrbTXZG1shOyVj9LD_OPCHE', '2024-08-08 04:02:04.951979'),
('e9lc29mpi1heatn0j6c7usmlx93xw970', '.eJxVjEEOwiAQRe_C2hAYKgwu3fcMZICpVA0kpV0Z765NutDtf-_9lwi0rSVsnZcwZ3ERTpx-t0jpwXUH-U711mRqdV3mKHdFHrTLsWV-Xg_376BQL9_aIpFN2iP6yaHhqBFAm7PXGtECoMeceIieIGkF4JQdnAGFGHmybhDvD7IYNkM:1sTeoX:bZ_cNvdV1bW-nue7fskI14HUg0-xBITgTOLEdZZqE78', '2024-07-30 09:49:41.687200'),
...
('jjcnuos9oyjx4lj58zv9iyly0m41m629', '.eJxVjLEOwjAMRP8lM4riUCspIzvfENmJTQqolZp2Qvw7rdQBlhvuvbu3SbQuNa1N5jQUczFoTr8dU37KuIPyoPE-2TyNyzyw3RV70GZvU5HX9XD_Diq1uq1dOSOxh4jcqwCCgHgXt2Dti1AOyBm7CBo6dqoEKgqAWDwFymA-X_ZNOKw:1sUhhO:TvXmeehKb8pu5pUne2dW0zHKbJqjvwULTEQFKEVgNAY', '2024-08-02 07:06:38.840042'),
('n1w5bu1fhcwghllzsi61i3f6b0yeb9k5', '.eJxVjMsOwiAQRf-FtSEgw8ul-34DAWaQqoGktCvjv2uTLnR7zzn3xULc1hq2QUuYkV2YY6ffLcX8oLYDvMd26zz3ti5z4rvCDzr41JGe18P9O6hx1G-tnKEE3lkUmM8KhY6EpLyHYiMJC8klY5AcFK0LIBUBukgikJpASPb-APcYOEs:1sgFuF:QOWyold0a1V_NFrU46FwcpvFdDpEr2jAx0-iPtTO7rI', '2024-09-03 03:51:39.229809'),
('nwhlzh6jc3t537hwqnl2kay6nwcx2ero', '.eJxVjMsOwiAQRf-FtSEwLY-6dO83kBkGpGogKe3K-O_apAvd3nPOfYmA21rC1tMSZhZn4cXpdyOMj1R3wHestyZjq-syk9wVedAur43T83K4fwcFe_nWpDPYqBTFEUEblbyPlL0e2A1TMpSZFUAaHIw-WgVo2BrIVmvLjiYj3h_o1DeZ:1swJv8:IsxOgoD06eVyZ2WOS-WCvEhMahDF1vt8_RNdznu9i8I', '2024-10-17 11:22:58.643233'),
...
('oj6px4tnakyqpte6z7pfug2r922rqmkj', '.eJxVjDsOwyAQRO9CHSHAGJaU6X0GtMsnOIlAMnYV5e6xJRdJMc28N_NmHre1-K2nxc-RXRmwy29HGJ6pHiA-sN4bD62uy0z8UPhJO59aTK_b6f4dFOxlXytjo8pSSxB2EBaGIWuniZTICZQYnR0hSowakzIETpG0QmtHwYDdwz5fru82lw:1sdnKZ:FnflTemcH6NSqQGNGNcceCrB2LwiEmEn9jkyr3pceCE', '2024-08-27 08:56:39.007044'),
('osjo640r5ah28k2d4g5wwi7ry1y8t2fo', '.eJxVjMsOwiAQRf-FtSEgw8ul-34DAWaQqoGktCvjv2uTLnR7zzn3xULc1hq2QUuYkV2YY6ffLcX8oLYDvMd26zz3ti5z4rvCDzr41JGe18P9O6hx1G-tnKEE3lkUmM8KhY6EpLyHYiMJC8klY5AcFK0LIBUBukgikJpASPb-APcYOEs:1sjAIZ:Mvd9_brnstezjhKF-70TNA6R0XplTilA6wm-wZY2jHs', '2024-09-11 04:28:47.303173'),
('p1w59o0vcqcd02478qcmf3t4qj72usnq', '.eJxVjMsOwiAURP-FtSHQ20Jx6b7f0HAfSNVA0sfK-O-2SRe6nDln5q3GuK153BaZx4nVVYG6_HYY6SnlAPyI5V411bLOE-pD0Sdd9FBZXrfT_TvIccn7mrzDvvHgQmiBTCJrhNOewJBjK8yuSy0ZBxHRYhRjATtpQk9gnBf1-QLieDgA:1sLbbc:BjUCAEw_ex4x_CpApyujOHo98EKW1CKctW1YwrVumIU', '2024-07-08 04:47:04.036930'),
('qmj9qe0ukgsr80alwfdfvyhhfzybucxn', '.eJxVjDsOwyAQRO9CHSHAGJaU6X0GtMsnOIlAMnYV5e6xJRdJMc28N_NmHre1-K2nxc-RXRmwy29HGJ6pHiA-sN4bD62uy0z8UPhJO59aTK_b6f4dFOxlXytjo8pSSxB2EBaGIWuniZTICZQYnR0hSowakzIETpG0QmtHwYDdwz5fru82lw:1sdpWG:GJS4bF_SXw5xv0NEG4WYMfaXAzqOVT4rqBykQaDUpIM', '2024-08-27 11:16:52.752411'),
('v6zvg18ohi02b1p9dbkrl6ydf7pin91r', '.eJxVjMsOwiAQRf-FtSEgw8ul-34DAWaQqoGktCvjv2uTLnR7zzn3xULc1hq2QUuYkV2YY6ffLcX8oLYDvMd26zz3ti5z4rvCDzr41JGe18P9O6hx1G-tnKEE3lkUmM8KhY6EpLyHYiMJC8klY5AcFK0LIBUBukgikJpASPb-APcYOEs:1sl0Tw:0_UwkmSj3S1B1KUKyzmQPLT_mRUwDlvOEhRo31EuWlQ', '2024-09-16 06:24:08.864891'),
('vsp8x562d38ajols6gp8bc8dn5d0z3eu', '.eJxVjDsOwyAQRO9CHSHAGJaU6X0GtMsnOIlAMnYV5e6xJRdJMc28N_NmHre1-K2nxc-RXRmwy29HGJ6pHiA-sN4bD62uy0z8UPhJO59aTK_b6f4dFOxlXytjo8pSSxB2EBaGIWuniZTICZQYnR0hSowakzIETpG0QmtHwYDdwz5fru82lw:1sdoL4:jdbcrWRUphfGkTSnSStuQYK7dpM1yg4l-NVCrEr_Qag', '2024-08-27 10:01:14.150289'),
('wi4hbkjd5wxn7h22erfp11d9sltw45n8', '.eJxVjDsOwyAQBe9CHSFAfFOmzxnQLgvBSQSSsSsrd48tuUjaNzNvYxHWpcZ15DlOxK7MssvvhpBeuR2AntAenafelnlCfij8pIPfO-X37XT_DiqMutcKpQUjQYaSMRklPFKRwppiyRPpoNIulOyMDuAlGCGwOEBJTgeHxD5f80k4XA:1sQnMJ:9Df2y_Sf0ttKYT01FFS7MmIqaDJ6iDuKBRSymXNlUss', '2024-07-22 12:20:43.974063'),
('zsmfnjb4blzyv010syzckachfahzrvtp', '.eJxVjMsOwiAQRf-FtSEgw8ul-34DAWaQqoGktCvjv2uTLnR7zzn3xULc1hq2QUuYkV2YY6ffLcX8oLYDvMd26zz3ti5z4rvCDzr41JGe18P9O6hx1G-tnKEE3lkUmM8KhY6EpLyHYiMJC8klY5AcFK0LIBUBukgikJpASPb-APcYOEs:1sjxbh:kJlG0gKkOnbiwA7o2UfGaM9EuC5RvfbeUzKojJi1ooI', '2024-09-13 09:07:49.387862');
...
(1, 'media/Kotakbank_k3bEa4Q.jpg', 'Grab Up to 12% OFF* on Domestic & International Flights.', 'Offer valid on Sunday\'s till 29th Feb ‘24');
...
(1, 'To avail the offer, customers must enter E-Coupon as per the table offered in the E-Coupon field.'),
(2, ' The offer will remain valid every Sunday from 28th January ’24 to 29th February ’24.'),
...
(10, '', '', '', '', 'Teerdha shall not be liable for any indirect, punitive, special, incidental or consequential damages arising out of or in connection with the offer.');
...
(1, 'media/BOB.png', 'Grab Upto 18% OFF* on Domestic and International Hotels.', 'CODE : TRDBOB');
...
(1, 'media/FEDERAL.png', 'UPTO 24% off on hotels with Federal Bank', 'CODE : TRDFDRL');
...
(1, 'media/HSBC.png', 'Upto 20% OFF On International Hotel Bookings Using HSBC credit cards.', 'CODE : TRDHSBC');
...
(1, 'media/ICIC.png', 'Grab FLAT 20% OFF* Upto Rs.8,000 on 3, 4 & 5-star hotel stays in India.', 'CODE: TRDICICI');
...
(1, 'media/kotk_bnk.png', 'Grab Upto 18% OFF* on Domestic and International Hotels.', 'CODE : TRDKOTK');
...
(1, 'media/SBI.png', 'Grab Flat 12% OFF* on Hotels & Homestays in India.', 'CODE : TRDSBI');
...
--
-- Indexes for table `booking_profiles`
--
...
--
-- Indexes for table `booking_sidebar_dashboard`
--
ALTER TABLE `booking_sidebar_dashboard`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `booking_profiles`
--
ALTER TABLE `booking_profiles`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT for table `booking_sidebar_dashboard`
--
ALTER TABLE `booking_sidebar_dashboard`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
-- Constraints for table `booking_profiles`
--
ALTER TABLE `booking_profiles`
  ADD CONSTRAINT `booking_profiles_user_id_cd79f0af_fk_auth_user_id` FOREIGN KEY (`user_id`) REFERENCES `auth_user` (`id`);
